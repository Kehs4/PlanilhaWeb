  ...
  return (
    <>
        <header>
          <nav>
              <div class="nav-title">
                <a href="https://vertisvet.com.br" target='blank'><img src="./vertisheader.png" width={105} height={35}></img></a>
      ...
      <footer class='footer-vertis'>
        <div class='div-all-footer'>
                ...
                <div class='mail-svg'>
                    ...
                    <a href="mailto:contato@gpiti.com.br" class='a-contact'><p>contato@gpiti.com.br</p></a>
                </div>
                ...
                <div class='whatsapp-svg'>
                    ...
                    <a href="https://wa.me/5511964410631" class='a-whatsapp' target='_blank'><p>(11) 96441-0631</p></a>
                </div>
                ...
                <div class='instagram-logo'>
                  ...
                  <a href='https://instagram.com/sistemavertis' class='a-instagram' target='_blank'><p>@sistemavertis</p></a>
                </div>
